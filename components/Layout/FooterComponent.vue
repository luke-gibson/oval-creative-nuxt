  ...
  <footer class="py-12 md:py-16">
    <LayoutContainerComponent class="flex justify-between flex-wrap items-end md:text-xl leading-6 md:leading-8">
      ...
      <div class="mt-6 md:mt-0 md:text-right">
        ...
        <p class="text-primary">Send a <NuxtLink class="font-bold text-secondary hover:text-primary transition-all" to="https://wa.me/+447513822562">WhatsApp</NuxtLink></p>
      </div>     
    </LayoutContainerComponent>
    <LayoutContainerComponent class="mt-8 md:mt-12 flex justify-between flex-wrap">
        <div class="w-full md:w-auto ">
          <p class="text-primary"><strong class="text-lg">&copy; Oval Creative</strong> <NuxtLink class="md:ml-8 block md:inline hover:text-secondary transition-all text-lg">Privacy Policy</NuxtLink> <NuxtLink class="md:ml-8 block md:inline hover:text-secondary transition-all text-lg">Terms and Conditions</NuxtLink> <NuxtLink class="md:ml-8 block md:inline hover:text-secondary transition-all text-lg">Cookie Policy</NuxtLink></p>
        </div>
