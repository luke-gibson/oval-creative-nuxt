...
useHead({
  title: 'Enterprise Package - £150/month | Oval Creative',
  meta: [
    {
      name: 'description',
      content: 'Complete package with ongoing SEO. Everything in Professional plus monthly SEO updates, keyword optimisation, and performance monitoring for £150/month.'
    }
  ]
})
...
const handleSubmit = async () => {
  ...
  try {
    const response = await fetch('https://formspree.io/f/mpqryqjg', {
      method: 'POST',
      headers: {
      ...
      <figcaption class="absolute bottom-2 left-3 right-3 md:bottom-6 md:left-8 md:right-6 max-w-lg md:max-w-3xl z-10">
        <div class="inline-block mb-4">
          <span class="bg-secondary text-primary px-4 py-2 rounded-full text-sm font-bold">
            Complete Package with SEO
          </span>
        </div>
        <h1 class="text-5xl md:text-6xl font-bold text-white mb-4">Enterprise Package</h1>
        <p class="text-3xl md:text-4xl font-bold">£150 <span class="text-xl text-white">per
            month</span></p>
      </figcaption>
    </figure>
  </LayoutContainerComponent>
      ...
      <div>
        ...
        <div class="space-y-4">
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Everything in Professional</h3>
              <p class="text-gray-300">Unlimited pages, CMS, training, news functionality, analytics, and priority
                support.</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Monthly SEO Updates</h3>
              <p class="text-gray-300">Ongoing search engine optimisation to continuously improve your rankings and
                organic traffic.</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Keyword Research & Optimisation</h3>
              <p class="text-gray-300">Identify the best keywords for your business and optimise your content to rank
                for them.</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="text-gray-300">Track your search rankings, traffic, and conversions with detailed monitoring.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Monthly Reporting</h3>
              <p class="text-gray-300">Transparent, easy-to-understand reports showing your progress and ROI.</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Content Recommendations</h3>
              <p class="text-gray-300">Strategic guidance on what content to create to attract and engage your target
                audience.</p>
            </div>
          </div>
          ...
          <div class="flex items-start">
            ...
            <div>
              <h3 class="text-xl font-bold text-white mb-2">Competitor Analysis</h3>
              <p class="text-gray-300">Understand what your competitors are doing and identify opportunities to outrank
                them.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/10 mb-8">
          <ul class="space-y-4 text-gray-300">
            <li class="flex items-start">
              ...
              <span>Businesses serious about organic growth</span>
            </li>
            <li class="flex items-start">
              <span class="text-secondary mr-2">•</span>
              <span>Companies in competitive industries</span>
            </li>
            <li class="flex items-start">
              <span class="text-secondary mr-2">•</span>
              <span>Businesses wanting to reduce ad spend</span>
            </li>
            <li class="flex items-start">
              <span class="text-secondary mr-2">•</span>
              <span>Companies focused on long-term ROI</span>
            </li>
            <li class="flex items-start">
              <span class="text-secondary mr-2">•</span>
              <span>Businesses ready to invest in SEO strategy</span>
            </li>
          </ul>
        </div>
        ...
        <div class="bg-gradient-to-br from-secondary/20 to-secondary/5 border-2 border-secondary rounded-2xl p-8">
          ...
          <div class="space-y-3 text-white">
            <p class="flex items-center">
              ...
              Complete website + SEO in 4-6 weeks
            </p>
            <p class="flex items-center">
              <svg class="w-5 h-5 text-secondary mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
  ...
  <section class="max-w-[1440px] mx-auto px-4 pb-14 md:pb-20">
    <div class="max-w-3xl mx-auto">
      <div class="text-center mb-12">
        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Get Started with Enterprise</h2>
      ...
      <form v-else @submit.prevent="handleSubmit"
        ...
        <div class="mb-6">
          <label for="website" class="block text-white font-semibold mb-2">Current Website *</label>
          <input v-model="form.website" type="url" id="website" required
            class="w-full px-4 py-3 bg-white/10 border-2 border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-secondary transition-colors"
            placeholder="https://example.com" />
          <p class="text-gray-400 text-sm mt-2">If you don't have a website yet, enter your industry or business type
          </p>
        </div>

        <div class="mb-6">
          <label for="currentRanking" class="block text-white font-semibold mb-2">What keywords do you currently rank
            for? (if known)</label>
          <textarea v-model="form.currentRanking" id="currentRanking" rows="3"
            ...
            placeholder="e.g., 'plumber portsmouth', 'web design agency', etc."></textarea>
        </div>

        <div class="mb-6">
          <label for="competitors" class="block text-white font-semibold mb-2">Who are your main competitors?</label>
          <textarea v-model="form.competitors" id="competitors" rows="3"
            class="w-full px-4 py-3 bg-white/10 border-2 border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-secondary transition-colors resize-none"
            placeholder="List competitor websites or company names"></textarea>
        </div>

        <div class="mb-6">
          <label class="block text-white font-semibold mb-3">What are your SEO goals? *</label>
          <div class="grid md:grid-cols-2 gap-3">
            <label v-for="option in seoGoalOptions" :key="option" class="flex items-center">
              <input type="checkbox" :value="option" v-model="form.seoGoals"
        ...
        <div class="mb-6">
          <label for="message" class="block text-white font-semibold mb-2">Tell us about your business and goals</label>
          <textarea v-model="form.message" id="message" rows="5"
            class="w-full px-4 py-3 bg-white/10 border-2 border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-secondary transition-colors resize-none"
            placeholder="What does your business do? What are your main challenges? What would success look like to you?"></textarea>
        </div>
